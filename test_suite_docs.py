...
class TestSuite:
    ...
    def test_inventory_n_f_a(self):
        ...
        page.in_fact_quantity('value')
        page.in_fact_amount('value')
    ...
    def test_estimated_income(self):
        ...
        page.kbk('value')
        page.kosgu('value')
        page.current_year_amount('value')
        page.first_plan_year_amount('value')
        page.second_plan_year_amount('value')
        page.click_by_text("Сохранить", order=2)
        page.click_by_text("Проводки")
        page.click_by_text("Сохранить")
        page.click_by_text("Закрыть")
