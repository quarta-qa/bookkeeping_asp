...
class TestSuite:
    ...
    def test_notification_of_the_type_and_payment_type(self):
        ...
        page.activity_kind(data["documents"]["notificationTypeAndPaymentType"]["Test"])
        ...
        page.document_foundation(data["documents"]["notificationTypeAndPaymentType"]["documentFoundation"])
        ...
        page.kosgu(data["documents"]["notificationTypeAndPaymentType"]["kosgu"])
        page.cost_element(data["documents"]["notificationTypeAndPaymentType"]["costElement"])
        page.recepient_kbk(data["documents"]["notificationTypeAndPaymentType"]["kbk"])
