...
class TestSuite:
    ...
    def te1st_incoming_act(self):
        ...
        page.document_kind(data["documents"]["incomingAct"]["documentKind"])
        page.document_number(data["documents"]["incomingAct"]["documentNumber"])
        page.document_date(data["documents"]["incomingAct"]["documentDate"])
        page.entry_date(data["documents"]["incomingAct"]["entryDate"])
        page.contractor(data["documents"]["incomingAct"]["organization"])
        page.department_unit(data["documents"]["incomingAct"]["departmentUnit"])
        page.comment(data["documents"]["incomingAct"]["comment"])
        # Акт входящий - добавление строки
        page.click_by_text("Строки документа")
        page.click_by_text("Добавить")
        page.click_by_text("Новую строку")
        page = IncomingActAddLinePage(self.driver)
        page.operation(data["documents"]["incomingAct"]["operation"])
        page.kbk(data["documents"]["incomingAct"]["kbk"])
        page.kosgu(data["documents"]["incomingAct"]["kosgu"])
        page.cost_elements(data["documents"]["incomingAct"]["costElement"])
        page.nds_percent(data["documents"]["incomingAct"]["ndsPercent"])
        page.amount(data["documents"]["incomingAct"]["amount"])
        page.advance_offset(data["documents"]["incomingAct"]["amount"])
        page.under_repair(data["documents"]["incomingAct"]["underRepair"])
        page.comment(data["documents"]["incomingAct"]["comment"])
        page.click_by_text("Сохранить", 2)
        page.click_by_text("Проводки")
        page.click_by_text("Сохранить")
    ...
    def test_information_about_the_monetary_obligation(self):
        ...
        page.document_number(data["documents"]["informationAboutTheMonetaryObligation"]["documentNumber"])
        page.document_date(data["documents"]["informationAboutTheMonetaryObligation"]["documentDate"])
        page.financial_year(data["documents"]["informationAboutTheMonetaryObligation"]["financialYear"])
        page.tracking_number(data["documents"]["informationAboutTheMonetaryObligation"]["trackingNumber"])
        page.currency(data["documents"]["informationAboutTheMonetaryObligation"]["currency"])
        page.is_advance(1)
        ...
        # Реквизиты документа-основания
        page.click_by_text("Реквизиты документа-основания")
        page.document_foundation_kind(
            data["documents"]["informationAboutTheMonetaryObligation"]["documentFoundationKind"])
        page.foundation_number(data["documents"]["informationAboutTheMonetaryObligation"]["documentNumber"])
        page.foundation_date(data["documents"]["informationAboutTheMonetaryObligation"]["documentDate"])
        page.foundation_amount(data["documents"]["informationAboutTheMonetaryObligation"]["amount"])
        page.foundation_subject(data["documents"]["incomingAct"]["comment"])
        # Расшифровка обязательства
        page.click_by_text("Расшифровка обязательства")
        page.click_by_text("Добавить")
        page.click_by_text("Новую строку")
        ...
        page.financial_year(data["documents"]["informationAboutTheMonetaryObligation"]["financialYear"])
        page.kbk(data["documents"]["informationAboutTheMonetaryObligation"]["kbk"])
        ...
        page.currency_amount(data["documents"]["informationAboutTheMonetaryObligation"]["amount"])
        page.click_by_text("Сохранить", 2)
        # История изменений
        page.click_by_text("История изменений")
        page.click_by_text("Добавить", 2)
        page = InformationAboutTheMonetaryObligationHistoryPage(self.driver)
        page.change_number(data["documents"]["informationAboutTheMonetaryObligation"]["financialYear"])
        page.change_date(data["documents"]["informationAboutTheMonetaryObligation"]["documentDate"])
        page.comment(data["documents"]["informationAboutTheMonetaryObligation"]["documentFoundationSubject"])
        page.click_by_text("Сохранить", 2)
        page.click_by_text("Сохранить")
        page.click_by_text("Закрыть")
    ...
    def test_creation_document_admission_nfa(self):
        ...
        page.document_number(data["documents"]["receiptOfNonFinancialAssetsCap"]["documentNumber"])
        page.document_kind(data["documents"]["receiptOfNonFinancialAssetsCap"]["documentKind"])
        page.document_date(data["documents"]["receiptOfNonFinancialAssetsCap"]["documentDate"])
        page.entry_date(data["documents"]["receiptOfNonFinancialAssetsCap"]["entryDate"])
        page.materially_responsible_person(data["documents"]["receiptOfNonFinancialAssetsCap"]["sender"])
        page.organization(data["documents"]["receiptOfNonFinancialAssetsCap"]["organization"])
        page.sender_sender_type(data["documents"]["receiptOfNonFinancialAssetsCap"]["senderSenderType"])
        page.employee(data["documents"]["invoiceFromVendor"]["employee"])
        page.storage(data["documents"]["receiptOfNonFinancialAssetsCap"]["storage"])
        page.advance_report(data["documents"]["receiptOfNonFinancialAssetsCap"]["advanceReport"])
        page.sender_foundation(data["documents"]["receiptOfNonFinancialAssetsCap"]["documentFoundation"])
        page.comment(data["documents"]["receiptOfNonFinancialAssetsCap"]["documentFoundationSubject"])
        ...
        page.operation(data["documents"]["receiptOfNonFinancialAssetsCap"]["operation"])
        page.quantity(data["documents"]["receiptOfNonFinancialAssetsCap"]["quantity"])
        page.amortization(data["documents"]["receiptOfNonFinancialAssetsCap"]["amount"])
        page.tag_no(data["documents"]["receiptOfNonFinancialAssetsCap"]["tagNo"])
        page.amount(data["documents"]["receiptOfNonFinancialAssetsCap"]["amount"])
        page.nds_percent(data["documents"]["receiptOfNonFinancialAssetsCap"]["ndsPercent"])
        page.advance_amount(data["documents"]["receiptOfNonFinancialAssetsCap"]["amount"])
        page.actually_used(data["documents"]["receiptOfNonFinancialAssetsCap"]["taxBillNumber"])
        page.comment(data["documents"]["receiptOfNonFinancialAssetsCap"]["comment"])
        # page.foundation(data["documents"]["receiptOfNonFinancialAssetsCap"]["documentFoundation"])
        page.department_unit(data["documents"]["receiptOfNonFinancialAssetsCap"]["departmentUnit"])
        page.storage(data["documents"]["receiptOfNonFinancialAssetsCap"]["storage"])
        page.kbk(data["documents"]["receiptOfNonFinancialAssetsCap"]["kbk"])
        page.kosgu(data["documents"]["receiptOfNonFinancialAssetsCap"]["kosgu"])
        page.cost_element(data["documents"]["receiptOfNonFinancialAssetsCap"]["costElement"])
        ...
        page.nds_percent(data["documents"]["receiptOfNonFinancialAssetsCap"]["ndsPercent"])
        page.advance_amount(data["documents"]["receiptOfNonFinancialAssetsCap"]["amount"])
        page.tag_no(data["documents"]["receiptOfNonFinancialAssetsCap"]["tagNo1"])
        # page.additional_features('value') - ошибка
        page.comment(data["documents"]["receiptOfNonFinancialAssetsCap"]["comment"])
        # page.foundation(data["documents"]["receiptOfNonFinancialAssetsCap"]["foundation"])
        page.department_unit(data["documents"]["receiptOfNonFinancialAssetsCap"]["departmentUnit"])
        page.storage(data["documents"]["receiptOfNonFinancialAssetsCap"]["storage"])
        page.cost_element(data["documents"]["receiptOfNonFinancialAssetsCap"]["costElement"])
        page.scroll_modal_to_bottom()
    ...
    def test_move_nfa(self):
        ...
        page.document_kind(data["documents"]["moveNFA"]["documentKind"])
        page.document_number(data["documents"]["moveNFA"]["documentNumber"])
        page.document_date(data["documents"]["moveNFA"]["documentDate"])
        page.entry_date(data["documents"]["moveNFA"]["entryDate"])
        page.addressee_materially_responsible_person(data["documents"]["moveNFA"]["sender"])
        page.addressee_storage(data["documents"]["moveNFA"]["storage"])
        page.sending_end_materially_responsible_person(data["documents"]["moveNFA"]["sender"])
        page.sending_end_storage(data["documents"]["moveNFA"]["storage"])
        page.comment(data["documents"]["moveNFA"]["comment"])
        # СОЗДАТЬ СТРОКУ "ОС,НМА" -
        page.click_by_text("Строки документа")
        page.click_by_text("Добавить")
        page.click_by_text("Новая строка ОС, НМА")
        page = MoveNFAAddNFAPage(self.driver)
        page.operation(data["documents"]["moveNFA"]["operation"])
        page.tag_no(data["documents"]["moveNFA"]["tagNo"])
        page.quantity(data["documents"]["moveNFA"]["quantity"])
        page.amount(data["documents"]["moveNFA"]["amount"])
        page.comment(data["documents"]["moveNFA"]["comment"])
        # page.sender_foundation(data["documents"]["moveNFA"]["documentFoundation"])
        # Вкладка аналитика
        page.click_by_text("Аналитика")
        page = MoveNFAAddNFADopPage(self.driver)
        page.kbk(data["documents"]["moveNFA"]["kbk"])
        page.kosgu(data["documents"]["moveNFA"]["kosgu"])
        page.cost_element(data["documents"]["moveNFA"]["costElement"])
        page.department_unit(data["documents"]["moveNFA"]["departmentUnit"])
        page.storage(data["documents"]["moveNFA"]["storage"])
        page.organization(data["documents"]["moveNFA"]["organization"])
        # Вкладка Новый номер
        page.click_by_text("Новый номер")
        page.new_tag_no(data["documents"]["moveNFA"]["tagNo"])
        page.new_quantity(data["documents"]["moveNFA"]["quantity"])
        page.click_by_text("Сохранить", order=2)
        ...
        page = MoveNFAAddNFAPage(self.driver)
        page.operation(data["documents"]["moveNFA"]["operation"])
        page.tag_no(data["documents"]["moveNFA"]["tagNo1"])
        page.quantity(data["documents"]["moveNFA"]["quantity"])
        page.amount(data["documents"]["moveNFA"]["amount"])
        page.comment(data["documents"]["moveNFA"]["comment"])
        # page.sender_foundation(data["documents"]["moveNFA"]["foundation"])
        ...
        # Вкладка Новый номер
        page.click_by_text("Новый номер")
        page.new_tag_no(data["documents"]["moveNFA"]["tagNo1"])
        page.new_quantity(data["documents"]["moveNFA"]["quantity"])
    ...
    def test_retirement_nfa(self):
        ...
        page.document_kind(data["documents"]["retirementNfa"]["documentKind"])
        page.document_number(data["documents"]["retirementNfa"]["documentNumber"])
        page.document_date(data["documents"]["retirementNfa"]["documentDate"])
        page.entry_date(data["documents"]["retirementNfa"]["entryDate"])
        page.retirement_addressee_type(data["documents"]["retirementNfa"]["retirementAddresseeType"])
        page.department(data["documents"]["retirementNfa"]["department"])
        page.retirement_addressee_type(data["documents"]["retirementNfa"]["retirementAddresseeTypeO"])
        page.organization(data["documents"]["retirementNfa"]["organization"])
        page.materially_responsible_person(data["documents"]["retirementNfa"]["sender"])
        page.storage(data["documents"]["retirementNfa"]["storage"])
        page.comment(data["documents"]["retirementNfa"]["comment"])
        page.committee_conclusion(data["documents"]["retirementNfa"]["comment"])
        # СОЗДАТЬ СТРОКУ "ОС,НМА" -
        page.click_by_text("Строки документа")
        page.click_by_text("Добавить")
        page.click_by_text("Новый объект ОС, НМА")
        page = RetirementNfaAddPage(self.driver)
        page.tag_no(data["documents"]["retirementNfa"]["tagNo"])
        page.amortization(data["documents"]["retirementNfa"]["amount"])
        page.operation(data["documents"]["retirementNfa"]["operation"])
        page.quantity(data["documents"]["retirementNfa"]["quantity"])
        page.price(data["documents"]["retirementNfa"]["amount"])
        page.amount(data["documents"]["retirementNfa"]["amount"])
        page.comment(data["documents"]["retirementNfa"]["comment"])
        # Вкладка аналитики
        page.click_by_text("Аналитики")
        page.kbk(data["documents"]["retirementNfa"]["kbk"])
        page.kosgu(data["documents"]["retirementNfa"]["kosgu"])
        page.cost_element(data["documents"]["retirementNfa"]["costElement"])
        page.department(data["documents"]["retirementNfa"]["department"])
        page.storage(data["documents"]["retirementNfa"]["storage"])
        page.organization(data["documents"]["retirementNfa"]["organization"])
        # Вкладка Ремонт ОС
        page.click_by_text("Ремонт ОС")
        page.under_repair_tag_no(data["documents"]["retirementNfa"]["tagNo"])
        ...
        page.tag_no(data["documents"]["retirementNfa"]["tagNo1"])
        page.operation(data["documents"]["retirementNfa"]["operation"])
        page.quantity(data["documents"]["retirementNfa"]["quantity"])
        page.price(data["documents"]["retirementNfa"]["amount"])
        # page.additional_features('value')
        ...
        # Вкладка Ремонт ОС
        page.click_by_text("Ремонт ОС")
        page.under_repair_tag_no(data["documents"]["retirementNfa"]["tagNo1"])
        # page.under_repair('value')
        page.click_by_text("Сохранить", order=2)
        page.click_by_text("Проводки")
        page.click_by_text("Сохранить")
    ...
    def test_accrual_of_amortization_on_the_os_under_the_account(self):
        ...
        page.balance_sheet_account(data["documents"]["depreciation"]["balanceSheetAccount"])
        ...
        page.document_number(data["documents"]["depreciation"]["documentNumber"])
        page.document_date(data["documents"]["depreciation"]["documentDate"])
        page.entry_date(data["documents"]["depreciation"]["entryDate"])
        page.comment(data["documents"]["depreciation"]["comment"])
        page.accrual_parameters(data["documents"]["depreciation"]["comment"])
        # Строки документа
        page.click_by_text("Строки документа")
        page.click_by_text("Добавить")
        page.click_by_text("Новый объект ОС, НМА")
        page = DepreciationAddLinePage(self.driver)
        page.operation(data["documents"]["depreciation"]["operation"])
        page.tag_no(data["documents"]["depreciation"]["tagNo"])
        page.balance_sheet_account(data["documents"]["depreciation"]["balanceSheetAccount"])
        page.actually_used(data["documents"]["depreciation"]["sfi"])
        page.carrying_value(data["documents"]["depreciation"]["amount"])
        page.current_amortization(data["documents"]["depreciation"]["amount"])
        page.accrued_depreciation(data["documents"]["depreciation"]["amount"])
        page.kbk(data["documents"]["depreciation"]["kbk"])
        page.kosgu(data["documents"]["depreciation"]["kosgu"])
        page.cost_element(data["documents"]["depreciation"]["costElement"])
        page.materially_responsible_person(data["documents"]["depreciation"]["sender"])
        page.comment(data["documents"]["depreciation"]["comment"])
        page.click_by_text("Сохранить", order=2)
        page.click_by_text("Проводки")
        page.click_by_text("Сохранить")
    ...
    def test_inventory_n_f_a(self):
        ...
        page.balance_sheet_account(data["documents"]["inventoryNFA"]["balanceSheetAccount"])
        page.balance_sheet_account_group(data["documents"]["inventoryNFA"]["balanceSheetAccountGroup"])
        page.document_number(data["documents"]["inventoryNFA"]["documentNumber"])
        page.document_date(data["documents"]["inventoryNFA"]["documentDate"])
        # page.committee(data["documents"]["inventoryNFA"]["cashReportNumber"]) -ошибка
        page.inventory_location(data["documents"]["inventoryNFA"]["comment2"])
        page.inventory_start_date(data["documents"]["inventoryNFA"]["documentDate"])
        page.inventory_end_date(data["documents"]["inventoryNFA"]["limitDate"])
        page.committee_conclusion(data["documents"]["inventoryNFA"]["documentFoundationSubject"])
        page.fill_actual_availability(1)
        page.materially_responsible_person(data["documents"]["inventoryNFA"]["sender"])
        page.storage(data["documents"]["inventoryNFA"]["storage"])
        page.separate_documents_by_materially_responsible_person(1)
        page.balance_sheet_account(data["documents"]["inventoryNFA"]["balanceSheetAccount"])
        page.click_by_text('Выполнить')
        sleep(5)
        page.click_by_text('Закрыть')
        ...
        page.tag_no_basic_facilities(data["documents"]["inventoryNFA"]["tagNo"])
        page.in_fact_quantity(data["documents"]["inventoryNFA"]["quantity"])
        page.in_fact_amount(data["documents"]["inventoryNFA"]["amount"])
        page.in_fact_materially_responsible_person(data["documents"]["inventoryNFA"]["sender"])
        page.in_fact_storage(data["documents"]["inventoryNFA"]["storage"])
        page.click_by_text("Сохранить", order=2)
        # Добавление строки МЗ
        page.click_by_text("Добавить")
        page.click_by_text("Новый объект МЗ")
        page.tag_no_mat_inventory(data["documents"]["inventoryNFA"]["tagNo1"])
        page.in_fact_quantity(data["documents"]["inventoryNFA"]["quantity"])
        page.in_fact_amount(data["documents"]["inventoryNFA"]["amount"])
        page.in_fact_materially_responsible_person(data["documents"]["inventoryNFA"]["sender"])
        page.in_fact_storage(data["documents"]["inventoryNFA"]["storage"])
    ...
    def test_procurement_notice(self):
        ...
        page.financial_year(data["documents"]["procurementNotice"]["financialYear"])
        page.document_number(data["documents"]["procurementNotice"]["documentNumber"])
        page.document_date(data["documents"]["procurementNotice"]["documentDate"])
        page.publish_date(data["documents"]["procurementNotice"]["documentDate"])
        page.demander(data["documents"]["procurementNotice"]["demander"])
        page.winner(data["documents"]["procurementNotice"]["drawee"])
        # page.order_placement('value') - ошибка
        page.identity_code(data["documents"]["procurementNotice"]["identityCode"])
        page.responsible(data["documents"]["procurementNotice"]["departmentUnit"])
        # page.budget_commitment_info('value')- ошибка
        page.works(data["documents"]["procurementNotice"]["paymentTerm"])
        page.contract_date(data["documents"]["procurementNotice"]["documentDate"])
        page.procedure_failure_date(data["documents"]["procurementNotice"]["documentDate"])
        page.starting_price(data["documents"]["inventoryNFA"]["amount"])
        page.cost(data["documents"]["inventoryNFA"]["amount"])
        page.tender_security(data["documents"]["inventoryNFA"]["amount"])
        # Добавляем строку документа
        page.click_by_text("Строки документа")
        page.click_by_text("Добавить")
        page.click_by_text("Новую строку")
        ...
        page.starting_price(data["documents"]["inventoryNFA"]["amount"])
        page.cost(data["documents"]["inventoryNFA"]["amount"])
        page.works(data["documents"]["inventoryNFA"]["amount"])
        page.click_by_text("Сохранить", order=2)
        page.click_by_text("Проводки")
        page.click_by_text("Сохранить")
        page.click_by_text("Закрыть")
    ...
    def test_estimated_income(self):
        ...
        page.financial_year(data["documents"]["estimatedIncome"]["financialYear"])
        page.document_date(data["documents"]["estimatedIncome"]["documentDate"])
        page.entry_date(data["documents"]["estimatedIncome"]["entryDate"])
        page.recipient(data["documents"]["estimatedIncome"]["demander"])
        page.account_details(data["documents"]["estimatedIncome"]["accountDetails"])
        page.operation(data["documents"]["estimatedIncome"]["operation"])
        # Расшифровка документа
        page.click_by_text("Расшифровка документа")
        page.click_by_text("Добавить")
        page.click_by_text("Новую строку")
        page = EstimatedIncomeAddLinePage(self.driver)
        page.item_date(data["documents"]["estimatedIncome"]["documentDate"])
        page.kbk(data["documents"]["estimatedIncome"]["kbk"])
        page.kosgu(data["documents"]["estimatedIncome"]["kosgu"])
        page.current_year_amount(data["documents"]["estimatedIncome"]["amount"])
        page.first_plan_year_amount(data["documents"]["estimatedIncome"]["amount"])
        page.second_plan_year_amount(data["documents"]["estimatedIncome"]["amount"])
        page.click_by_text("Сохранить", order=2)
        page.click_by_text("Проводки")
        page.click_by_text("Сохранить")
        page.click_by_text("Закрыть")
