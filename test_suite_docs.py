...
class TestSuite:
    ...
    def test_accrual_of_amortization_on_the_os_under_the_account(self):
        ...
        page.current_amortization(data["documents"]["receiptOfNonFinancialAssetsCap"]["amount"])
    ...
    def test_inventory_n_f_a(self):
        ...
        page.in_fact_storage(data["documents"]["receiptOfNonFinancialAssetsCap"]["storage"])
        page.click_by_text("Сохранить", order=2)
